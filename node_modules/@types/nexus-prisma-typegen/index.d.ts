...
interface NexusPrismaInputs {
  Query: {
    categories: {
  filtering: 'id' | 'slug' | 'title' | 'Post' | 'AND' | 'OR' | 'NOT'
  ordering: 'id' | 'slug' | 'title'
}
    posts: {
  filtering: 'id' | 'public' | 'title' | 'text' | 'created_at' | 'updated_at' | 'user_id' | 'Category' | 'AND' | 'OR' | 'NOT' | 'User'
  ordering: 'id' | 'public' | 'title' | 'text' | 'created_at' | 'updated_at' | 'user_id' | 'User'
}
    users: {
  filtering: 'avatar' | 'created_at' | 'email' | 'password' | 'first_name' | 'id' | 'last_name' | 'updated_at' | 'Post' | 'AND' | 'OR' | 'NOT'
  ordering: 'avatar' | 'created_at' | 'email' | 'password' | 'first_name' | 'id' | 'last_name' | 'updated_at'
}

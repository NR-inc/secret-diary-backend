...
class Publisher {
    ...
    publishInputObjectType(inputType) {
        ...
        return Nexus.inputObjectType({
            ...
            definition: t => {
                inputType.fields
                    .map(field => (Object.assign(Object.assign({}, field), { inputType: Object.assign(Object.assign({}, field.inputType), { type: this.isPublished(field.inputType.type)
